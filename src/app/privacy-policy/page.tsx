...
export const metadata = {
  title: 'プライバシーポリシー | Saira',
  description: 'Sairaのプライバシーポリシーについてご説明します。',
}
    ...
    <div className="bg-white py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none">
          <p>
            株式会社Saira（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
          </p>
          ...
          <h2 className="text-xl font-semibold mt-8 mb-4">第10条（お問い合わせ窓口）</h2>
          <p>
